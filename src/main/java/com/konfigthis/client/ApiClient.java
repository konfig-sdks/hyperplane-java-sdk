...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.sandbox-65ebc.chico.ai/v1";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("PASETO", new ApiKeyAuth("header", "Authorization"));
        ...
        if (configuration != null) {
            if (configuration.pASETO != null) {
                this.setPASETO(configuration.pASETO);
            }
            setVerifyingSsl(configuration.verifyingSsl);
        }
    }

    public String getPASETO() {
        return ((ApiKeyAuth) this.getAuthentication("PASETO")).getApiKey();
    }

    public void setPASETO(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("PASETO")).setApiKey(apiKey);
    }

    public void setPASETOPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("PASETO")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.sandbox-65ebc.chico.ai/v1)
